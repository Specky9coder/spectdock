...
export default function Home({posts}: InferGetStaticPropsType<typeof getStaticProps>) {
    return (
        <>
            ...
            <span
                className="relative inset-y-4 ml-24 inline-block px-1 before:absolute before:-inset-1 before:block before:-skew-y-6 before:rounded-lg before:bg-primary-600 before:bg-opacity-20 sm:inset-y-7 sm:ml-40">
              <span className="relative inline-block -rotate-6 text-primary-500">
                <Link
                    href="https://twitter.com/specky9coder"
                ...
                >
                  @specky9coder
                        ...
                        <h1 className="pt-2 text-4xl font-bold leading-9 tracking-tight text-background-color dark:text-gray-100 sm:text-5xl sm:leading-10 md:text-6xl md:leading-snug">
                            Keyur
                            <span
                                className="relative inset-y-8 ml-2 inline-block -rotate-12 font-arrow text-primary-500 sm:inset-y-14">
                ^
              </span>
                            Bhadani
                        </h1>
                        <p className="text-black dark:text-white sm:pr-6 sm:text-lg sm:leading-8">
                            Welcome to my SpectDock – I am a Software Engineer by training and Full-Stack Engineer
                            by passion who loves building for the web & mobile. Also sometimes for the toaster.{' '}
                            {/* In my
                        ...
                        return (
                            ...
                            >
                                ...
                                <article className="relative h-full rounded-xl bg-background-color">
                                    <div
                                        className="flex h-full flex-col justify-between rounded-xl bg-white p-5 dark:bg-background-color">
                                        <div
                                            className="flex flex-col justify-between space-y-5 md:flex-row xl:col-span-3">
